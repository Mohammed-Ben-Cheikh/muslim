            ...
            <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                <div class="flex h-16 items-center justify-between">
                    <div class="flex items-center">
                        <div class="shrink-0">
                            <img class="h-12 w-36" src="https://www.youcode.ma/images/logos/youcode.png"
                                alt="Your Company">
                        </div>
                                ...
                                <div>
                                    <button type="button"
                                        ...
                                        <img class="size-8 rounded-full"
                                            src="https://intranet.youcode.ma/storage/users/profile/thumbnail/1082-1728486744.JPG"
                                            alt="">
                                    </button>
                                </div>
                            </div>
            ...
            <div class="md:hidden" id="mobile-menu">
                ...
                <div class="border-t border-gray-700 pt-4 pb-3">
                    <div class="flex items-center px-5">
                        ...
                        <div class="ml-3">
                            <div class="text-base/5 font-medium text-white">mohammed ben cheikh</div>
                            <div class="text-sm font-medium text-gray-400">bencheikh.official@gmail.com</div>
                        </div>
                        <button type="button"
